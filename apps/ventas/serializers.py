    ...
    class VentaDetalleSerializer(serializers.ModelSerializer):
        class Meta:
            model  = VentaDetalle
            fields = ['producto_id', 'cantidad', 'precio']
            extra_kwargs = {
    ...
    class VentaSerializer(serializers.ModelSerializer):
        ...
        detalles       = VentaDetalleSerializer(
            many=True,
            write_only=True,
            help_text="Lista de items: producto_id, cantidad, precio"
        )
        ...
        def create(self, validated_data):
            ...
            # Calcula el total sumando cantidad × precio
            total = sum(item['cantidad'] * item['precio'] for item in detalles_data)
